...
class GroupDetailsWidget extends StatefulWidget {
  ...
  final String group;
  final List<TransactionCategoryViewRow>? category;
  final String type;
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsetsDirectional.fromSTEB(5.0, 8.0, 0.0, 8.0),
                    child: Text(
                      valueOrDefault<String>(
                        widget.type,
                        'type',
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(16.0, 24.0, 16.0, 30.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'GROUP_DETAILS_DELETE_GROUP_BTN_ON_TAP');
                            var shouldSetState = false;
                            logFirebaseEvent('Button_backend_call');
                            _model.exisitingCategories =
                                await TransactionCategoryViewTable().queryRows(
                              queryFn: (q) => q
                                  .eqOrNull(
                                    'user_id',
                                    currentUserUid,
                            ...
                            shouldSetState = true;
                            if (formatNumber(
                                  _model.exisitingCategories?.length,
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return WebViewAware(
                                    child: AlertDialog(
                                      title: const Text('Error Deleting Group'),
                                      content: const Text(
                                          'Must remove all categories from group before deleting group.'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                            ...
                            logFirebaseEvent('Button_backend_call');
                            await TransactionGroupTable().delete(
