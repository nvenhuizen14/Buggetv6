              ...
              Expanded(
                child: Container(
                  constraints: BoxConstraints(
                    minWidth: 99.5,
                    maxWidth: MediaQuery.sizeOf(context).width * 0.995,
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'TRANSACTION_DETAILS_Container_35660e3q_O');
                                          logFirebaseEvent(
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'TRANSACTION_DETAILS_Container_5pdrjnuy_O');
                                          logFirebaseEvent(
                                              'Container_bottom_sheet');
                                          showModalBottomSheet(
                                            isScrollControlled: true,
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'TRANSACTION_DETAILS_Container_rdta0w77_O');
                                          logFirebaseEvent(
                                              'Container_bottom_sheet');
                                          showModalBottomSheet(
                                            isScrollControlled: true,
